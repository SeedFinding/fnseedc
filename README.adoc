...
* https://arxiv.org/pdf/math/0005139.pdf[Rational points near curves and small nonzero |x3 − y2| via lattice reduction by Noam D. Elkies]
...
* https://www.emsec.ruhr-uni-bochum.de/media/crypto/attachments/files/2011/03/DA_Bartkewitz.pdf[I m proved Lattice Basis Red uction Algorithms and their Efficient Implementation on Parallel Systems by Timo Bartkewitz]
